...
namespace Xle.Serialization
{
    ...
    {
        private Dictionary<Type, IXleTypeSerializer> mInherited = new Dictionary<Type, IXleTypeSerializer>();
        private Dictionary<Type, IXleTypeSerializer> mDirect = new Dictionary<Type, IXleTypeSerializer>();
