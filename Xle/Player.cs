...
namespace ERY.Xle
{
    ...
    {
        private AttributeContainer mAttributes = new AttributeContainer();
        private double food;
        private int gold;
        private int goldBank;
        private double timedays;
        private double timequality;
        private int onRaft = -1;
        ...
        private WeaponItem bareHands = new WeaponItem();
        private ArmorItem bareArmor = new ArmorItem();
        private List<WeaponItem> weapons = new List<WeaponItem>();
        private List<ArmorItem> armor = new List<ArmorItem>();
        private ItemContainer mItems = new ItemContainer();
        private int hold;
        private int lastAttacked;
        private int[] chests = new int[50];
        private List<RaftData> rafts = new List<RaftData>();
