...
namespace ERY.Xle
{
    public class XleTitleScreen
    {
        ...
        void DisplayTitleScreen()
        {
            ...
            switch (titleState)
            {
                ...
                case TitleScreenState.NewGame:
                    ...
                    XleCore.DrawInnerLine(10 * 16, 10 * 16, 1, 19 * 16 - 4, Color.White);
                    XleCore.DrawInnerLine(10 * 16, 12 * 16, 1, 19 * 16 - 2, Color.White);
                    XleCore.DrawInnerLine(10 * 16, 10 * 16, 0, 3 * 16 - 4, Color.White);
                    XleCore.DrawInnerLine(28 * 16, 10 * 16, 0, 3 * 16 - 4, Color.White);
        ...
        public void Run()
        {
            ...
            while (Display.CurrentWindow.Closed == false && !titleDone)
            {
                UpdateTitleScreen();
        ...
        void SetMenu1()
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                color[11][i] = Color.LightGray;
                color[13][i] = Color.LightGray;
                color[15][i] = Color.LightGray;
                color[18][i] = Color.Blue;
            }
        ...
        void SetMenu2()
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                color[18][i] = Color.Yellow;
                color[22][i] = Color.Yellow;
            }
