...
namespace ERY.Xle
{
    ...
    public abstract class XleMap
    {
        ...
        */
        ...
        [Obsolete("X and Y were reversed.  Check them.")]
...
*/
        ...
        /// Passed type must derive from LotaEvent.
        /// </summary>
        /// <param name="t"></param>
        /// <returns></returns>
        public bool HasSpecialType(Type t)
        {
            Type basetype = typeof(XleEvent);

            if (basetype.IsAssignableFrom(t) == false)
            {
                throw new Exception("Argument to HasSpecialType must derive from LotaEvent");
            }
    ...
    namespace XleMapTypes
    {
        ...
        public class Outside : XleMap
        {
            ...
            public override bool PlayerXamine(Player player)
            {
                ...
                builder.AddText("Travel: ", Color.White);
                builder.AddText(travel.ToString(), Color.Green);
                builder.AddText("  -  Food use: ", Color.White);
                builder.AddText(food.ToString(), Color.Green);
            ...
            public override bool PlayerFight(Player player)
            {
                ...
                if (EncounterState == 10)
                {
                    ...
                    builder.AddText("Attack ", Color.White);
                    builder.AddText(MonstName(), Color.Cyan);

                    g.AddBottom(builder);
                    builder.Clear();

                    builder.AddText("with ", Color.White);
                    builder.AddText(weaponName, Color.Cyan);
                    ...
                    if (dam > 0)
                    {
                        ...
                        builder.AddText("Enemy hit by blow of ", Color.White);
                        builder.AddText(dam.ToString(), Color.Cyan);
                    ...
                    else
                    {
                        ...
                        g.AddBottom("Your Attack missed.", Color.Yellow);
                    }
                    ...
                    if (KilledOne())
                    {
                        ...
                        if (finished)
                        {
                            ...
                            if (food > 0)
                            {
                                ...
                                {
                                    builder = new ColorStringBuilder();
                                    builder.AddText("You gain ", Color.White);
                                    builder.AddText(food.ToString(), Color.Green);
                                    builder.AddText(" days of food.", Color.White);
                            ...
                            else if (gold > 0)
                            {
                                ...
                                builder.AddText("You find ", Color.White);
                                builder.AddText(gold.ToString(), Color.Yellow);
                                builder.AddText(" gold.", Color.White);
            ...
            public override void PlayerCursorMovement(Player player, Direction dir)
            {
                ...
                if (player.Move(stepDirection) == false)
                {
                    ...
                    if (player.IsOnRaft)
                    {
                        ...
                        g.AddBottom("");
                        g.AddBottom("The raft must stay in the water.", Color.Cyan);
                    }
                    else if (terrain == TerrainType.Water)
                    {
                        ...
                        g.AddBottom("");
                        g.AddBottom("There is too much water for travel.", Color.Cyan);
                    }
            ...
            void SpeakToMonster(Player player)
            {
                ...
                switch (type)
                {
                    ...
                    case 2:         // buy weapon
                        ...
                        builder = new ColorStringBuilder();
                        builder.AddText("Do you want to buy a", Color.Cyan);
                        if (qual == 4)
                            builder.AddText("n", Color.Cyan);

                        builder.AddText(quality[qual], Color.White);
                        ...
                        if (type == 1)
                        {
                            ...
                            builder.AddText(g.ArmorName(item), Color.White);
                            builder.AddText(" for ", Color.Cyan);
                            builder.AddText(cost.ToString(), Color.White);
                            builder.AddText(" Gold?", Color.Cyan);
                        }
                        else if (type == 2)
                        {
                            ...
                            builder.AddText(g.WeaponName(item), Color.White);
                            builder.AddText(" for ", Color.Cyan);
                            builder.AddText(cost.ToString(), Color.White);
                            builder.AddText(" Gold?", Color.Cyan);
                    ...
                    case 3:			// buy food
                        ...
                        builder = new ColorStringBuilder();
                        builder.AddText("Do you want to buy ", Color.Green);
                        builder.AddText(item.ToString(), Color.Yellow);

                        g.AddBottom(builder);
                        builder.Clear();

                        // line 2
                        builder.AddText("Days of food for ", Color.Green);
                        builder.AddText(cost.ToString(), Color.Yellow);
                        builder.AddText(" gold?", Color.Green);
                    ...
                    case 4:			// buy hp
                        ...
                        builder = new ColorStringBuilder();
                        builder.AddText("Do you want to buy a potion worth ", Color.Green);
                        ...
                        // line 2
                        builder.AddText(item.ToString(), Color.Yellow);
                        builder.AddText(" Hit Points for ", Color.Green);
                        builder.AddText(cost.ToString(), Color.Yellow);
                        builder.AddText(" gold?", Color.Green);
            ...
            private bool CheckStormy(Player player)
            {
                ...
                if (Stormy != wasStormy || Stormy >= 2)
                {
                    ...
                    {
                        g.AddBottom("");
                        g.AddBottom("You are sailing into stormy water.", Color.Yellow);
                    }
                    else if (Stormy == 2 || Stormy == 3)
                    {
                        g.AddBottom("");
                        g.AddBottom("The water is now very rough.", Color.White);
                        g.AddBottom("It will soon swamp your raft.", Color.Yellow);
                    }
                    else if (Stormy == 1 && wasStormy == 2)
                    {
                        g.AddBottom("");
                        g.AddBottom("You are out of immediate danger.", Color.Yellow);
                    }
                    else if (Stormy == 0 && wasStormy == 1)
                    {
                        g.AddBottom("");
                        g.AddBottom("You leave the storm behind.", Color.Cyan);
                    }

                    if (Stormy == 3)
                    {
                        g.AddBottom("");
                        g.AddBottom("Your raft sinks.", Color.Yellow);
                        g.AddBottom("");
                    }
            ...
            public void TestEncounter(Player player, KeyCode cursorKeys)
            {
                ...
                if (EncounterState == 0 && stepCount <= 0)
                {
                    ...
                    if (type < 10)
                    {
                        ...
                        g.AddBottom("");
                        g.AddBottom("An unknown creature is approaching ", Color.Cyan);
                        g.AddBottom("from the " + dirName + ".", Color.Cyan);
                ...
                else if (EncounterState == 10)
                {
                    ...
                    {
                        ColorStringBuilder builder = new ColorStringBuilder();
                        builder.AddText("Attacked by ", Color.White);
                        builder.AddText(monstCount.ToString(), Color.Yellow);
                        builder.AddText(" " + currentMonst[0].mName, Color.Cyan);
                        ...
                        builder.Clear();
                        builder.AddText("Hits:  ", Color.White);
                        builder.AddText(hits.ToString(), Color.Yellow);
                        builder.AddText("   Damage:  ", Color.White);
                        builder.AddText(dam.ToString(), Color.Yellow);
            ...
            public override void GetBoxColors(out Color boxColor, out Color innerColor, out Color fontColor, out int vertLine)
            {
                ...
                boxColor = Color.FromArgb(159, 112, 64);
        ...
        public class Town : XleMap, ERY.Xle.IHasGuards, ERY.Xle.IHasRoofs
        {
            ...
            int mBuyRaftMap;             // map and coors that mark where a purchased raft shows up
            Point mBuyRaftPt;
            ...
            int AttackGuard(Player player, int grd)
            {
                ...
                if (dam > 0)
                {
                    ...
                    builder.AddText("Guard struck  ", Color.Yellow);
                    builder.AddText(dam.ToString(), Color.White);
                ...
                {
                    g.AddBottom("Attack on guard missed", Color.Purple);
                    SoundMan.PlaySound(LotaSound.PlayerMiss);
                }
     ...
     */
            ...
            */
            ...
            public void BuyRaft(Player player)
            {
        ...
        public class Dungeon : XleMap
        {
            ...
            public override bool PlayerClimb(Player player)
            {
                ...
                else
                {
                    ...
                    g.AddBottom("");
                    g.AddBottom(tempstring, Color.White);
