...
namespace ERY.Xle
{
    ...
    case 20:
        ...
        public void Armor()
        {
            ...
            builder.AddText("-choose above", Color.Cyan);
        ...
        public void Disembark()
        {
            ...
            {
                g.AddBottom("");
                g.AddBottom("Nothing to disembark", Color.Yellow);
        ...
        public void End()
        {
            ...
            else
            {
                ...
                builder.AddText("Game ", Color.White);
                builder.AddText("not", Color.Yellow);
                builder.AddText(" saved.", Color.White);
            ...
            if (saved == false)
                g.AddBottom("Unsaved game will be lost.", Color.Yellow);
            else
                g.AddBottom("");
        ...
        public void GameSpeed()
        {
            ...
            g.AddBottom("** Change game speed **", Color.Yellow);
            g.AddBottom("     (1 is fastest)", Color.Yellow);
            g.AddBottom("");
            ...
            builder.AddText("Gamespeed is: ", Color.White);
            builder.AddText(player.Gamespeed.ToString(), Color.Yellow);
        ...
        public void Inventory()
        {
            ...
            while (inventoryScreen < 2)
            {
                ...
                XleCore.DrawLine(0, 128, 1, XleCore.myWindowWidth, Color.Gray);

                XleCore.DrawInnerBorder(Color.Yellow);
                XleCore.DrawInnerLine(0, 128, 1, XleCore.myWindowWidth, Color.Yellow);
