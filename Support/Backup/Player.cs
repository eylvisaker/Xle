    ...
    public class Player
    {
        ...
        public bool SaveGame()
        {
            ...
            if (g.Menu('e') == "End")
            {
                ...
                //            g.AddBottom("");
                //            g.AddBottom("Failed to save file.", Color.Yellow);
                //            g.AddBottom("Error code: " + string((signed)err), Color.Yellow);
                //            g.AddBottom("");
                ...
                //g.AddBottom("");
                //g.AddBottom("Game saved successfully.", Color.Green);

                g.AddBottom("");
                g.AddBottom("Save game not implemented.", Color.Green);
        ...
        public bool LoadGame(string game)
        {
            ...
            //    g.AddBottom("");
            //    g.AddBottom("Game loaded successfully.", Color.Green);
